...
def test_provider_e_money_consumed_by_cash_in() -> None:
    result = forecast_liquidity(
        Decimal("22000"), Decimal("5000"), RateInput(Decimal("30600"), Decimal("10800"), 60)
    )
...
def test_shared_cash_consumed_by_cash_out() -> None:
    result = forecast_shared_cash(
        Decimal("22000"), Decimal("10000"), RateInput(Decimal("3000"), Decimal("15000"), 60)
    )
...
def test_zero_consumption_returns_no_estimate() -> None:
    result = forecast_liquidity(
        Decimal("50000"), Decimal("5000"), RateInput(Decimal("1000"), Decimal("2000"), 15)
    )
